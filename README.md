...
> Если перед выбором приближения смотреть на графический вид функции, то можно подобрать интервал, где она будет являться выпуклой
